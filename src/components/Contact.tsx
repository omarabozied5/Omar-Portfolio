...
export const Contact = () => {
  ...
  const EMAILJS_SERVICE_ID = "service_rsy2rij";
  const EMAILJS_TEMPLATE_ID = "template_ojmb248";
  const EMAILJS_PUBLIC_KEY = "bco42pzf86AZ2qocO";
    ...
    try {
      ...
      const result = await emailjs.send(
        ...
        EMAILJS_TEMPLATE_ID,
        {
          ...
          to_name: "Omar Abuzaid", // Your name
          to_email: "omarabuzeid.pro@gmail.com", // Your email
        },
        EMAILJS_PUBLIC_KEY
      );
            ...
            <div className="space-y-8 opacity-0 animate-fadeInLeft animate-delay-600">
              <div>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  ...
                  from you. I'm passionate about creating amazing digital
                  experiences and always open to new challenges.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {contactInfo.map((contact, index) => (
                  ...
                  >
                    <div
                      className={`flex-shrink-0 w-12 h-12 bg-gradient-to-r ${contact.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
